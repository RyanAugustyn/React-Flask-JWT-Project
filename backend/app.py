...
from resources.books import UserReviewsResource, FavoritesResource, GetBookInformationResource, ReviewDetailResource, FavoriteResource
...
def create_routes():
    ...
    api.add_resource(FavoriteResource, '/api/user_favorites/<int:favorite_id>')
